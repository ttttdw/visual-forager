...
## don't concatenate valued simularity map and unvalued simularity map
class Actor(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(8, 12, 1)
        self.conv2 = nn.Conv2d(12, 16, 1)
    ...
    def forward(self, attention_map, values):
        ...
        attention_map = torch.cat((attention_map, torch.ones_like(attention_map,device=self.device) * values),1)
        # forward
        ...
        out = self.dropout(f.leaky_relu(self.fc5(out1)))
