...
class GridVisualForagingEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, task_mode=1):
        ...
        self.rewards = [[4, 4, 4, 4], [2, 4, 16, 8], [2, 4, 8, 16]]
    ...
    def _get_obs(self):
        if self.render_mode == "human":
            ...
            for position in self.target_ones:
                ...
                x = int(render_position[0])
                y = int(render_position[1])
                canvas.paste(self.target_set[0], (x, y))
            ...
            for position in self.target_twos:
                ...
                x = int(render_position[0])
                y = int(render_position[1])
                canvas.paste(self.target_set[1], (x, y))
            ...
            for position in self.target_threes:
                ...
                x = int(render_position[0])
                y = int(render_position[1])
                canvas.paste(self.target_set[2], (x, y))
            ...
            for position in self.target_fours:
                ...
                x = int(render_position[0])
                y = int(render_position[1])
                canvas.paste(self.target_set[3], (x, y))
